        ...
        <div class="modal-content" style="max-width: 900px;">
            <div class="modal-header">
                <div class="modal-title-wrapper">
                    <span class="material-symbols-rounded modal-icon" style="font-size: 28px; color: #151A2D; margin-right: 12px;">payments</span>
            ...
            <form id="costForm" novalidate>
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>
                                ...
                                <span class="info-icon" title="<?php echo $t_costs['cost_code_info'] ?? 'Cost code is automatically generated by the system'; ?>">
                                    <span class="material-symbols-rounded" style="font-size: 16px; vertical-align: middle; color: #6b7280;">info</span>
                                </span>
                            </label>
                            <input type="text" name="cost_code" id="costCodeInput" readonly placeholder="<?php echo $t_costs['cost_code_auto'] ?? 'Auto-generated (FST...)'; ?>" style="background-color: #f3f4f6; cursor: not-allowed;">
                            <small class="form-hint" style="color: #6b7280; margin-top: 6px; display: block; font-size: 13px;">
                    ...
                    <div class="form-group">
                        <div class="form-group-header">
                            ...
                            <button type="button" class="btn-secondary btn-sm" onclick="addPeriod()">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn-secondary" onclick="closeModal('costsModal')" id="cancelCostBtn">
                    ...
                    <button type="submit" class="btn-primary" id="saveCostBtn">
                        ...
                        <span class="btn-loading-spinner" style="display: none; margin-left: 8px;">
                            <span class="material-symbols-rounded" style="animation: spin 1s linear infinite; font-size: 18px;">sync</span>
                        </span>
                    </button>
                </div>
            </form>
